...
"""autogenerated by genpy from roma_vision/obstacles.msg. Do not edit."""
import sys
...
class obstacles(genpy.Message):
  _md5sum = "4079861bcc588d6429dc8dce9e7ca922"
  _type = "roma_vision/obstacles"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32[] angles
float32[] distances"""
  __slots__ = ['angles','distances']
