...
(cl:defmethod cl:initialize-instance :after ((m <obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roma_vision-msg:<obstacles> is deprecated: use roma_vision-msg:obstacles instead.")))

(cl:ensure-generic-function 'angles-val :lambda-list '(m))
(cl:defmethod angles-val ((m <obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roma_vision-msg:angles-val is deprecated.  Use roma_vision-msg:angles instead.")
  (angles m))

(cl:ensure-generic-function 'distances-val :lambda-list '(m))
(cl:defmethod distances-val ((m <obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roma_vision-msg:distances-val is deprecated.  Use roma_vision-msg:distances instead.")
  (distances m))
