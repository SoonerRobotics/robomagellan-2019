...
IMU::IMU() {
	...
	if (!bno.begin())
	{
		...
		throw new Exception("Ooops, no BNO055 detected ... Check your wiring or I2C ADDR!");
	}
...
bool IMU::setOffset(const uint8_t* calibData) {
	return bno.setSensorOffsets(calibData);
}